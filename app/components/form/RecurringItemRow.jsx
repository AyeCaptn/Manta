...
const ItemAttributeContainer = styled.div`
  min-height: 36px;
  border-radius: 4px;
  padding: 0 10px;
  font-size: 16px;
...
// Component
export class RecurringItemRow extends Component {
  constructor(props) {
    super(props);
  ...
  render() {
    const { t, actions, hasHandler, item } = this.props;
...
export default compose(_withDraggable)(RecurringItemRow);
